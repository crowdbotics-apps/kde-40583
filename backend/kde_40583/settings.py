"""
Django settings for kde_40583 project.
...
WSGI_APPLICATION = 'kde_40583.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kde_40583 API",
    "DESCRIPTION": "API documentation for kde_40583 App",
    "VERSION": "v1",
}
